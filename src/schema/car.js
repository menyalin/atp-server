...
extend type Query {
  carsForVuex: [Car]
  freeCars(dateRange: String!, carUnitId: String trailerId: String truckId: String): [Car]
  ...
  carUnitsPage(offset: Int, limit: Int, driver: String, truckId: String, trailerId: String, date: String): CarUnitPage
